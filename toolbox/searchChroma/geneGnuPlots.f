...
C     > ,' + Qy4*x*x*x*x'
     ...
     > ,' w p pt 10 ps 1.9  lc 1 tit "tracking, Q_x", \'
      write(8,fmt='(2a)') '     "tunesFromMatrix.out" u ($13-1):($4)   '
     > ,' w p pt 11 ps 1.9  lc 3 tit "tracking, Q_y", \'
      write(8,fmt='(a)') '     Qx(x) w l lw 1.5 lc 1 tit "fit, Q_x",\'
      write(8,fmt='(a)') '     Qy(x) w l lw 1.5 lc 3 tit "fit, Q_y" '
      write(8,fmt='(a)') ' '
...
C     >     'print Qy0, Qy1, Qy2, Qy3, "   Qy'', Qy'''', Qy'''''' '
     ...
     >,' w p pt 10 ps 1.3 lc 1  tit "x-x''",\'
      write(8,fmt='(2a)')'"tunesFromFai.out" u ($1*1e2):($7) axes x1y2'
     >,'   w p pt 10 ps 1.5  lc 1 tit "emittance" ,\'
      write(8,fmt='(2a)')'"tunesFromFai.out" u ($1*1e2):($7) axes x1y2'
     >,'  w l lw 1.3  lc 1 notit'
      write(8,fmt='(a)') ' '
      write(8,fmt='(a)') 'pause 3 '
      write(8,fmt='(a)') ' '
      write(8,fmt='(2a)') 'set terminal postscript eps blacktext color'
     ...
     >,' w p pt 10 ps 1.3 lc 3 tit "y-y''",\'
      write(8,fmt='(2a)')'"tunesFromFai.out" u ($13*1e2):($8) axes x1y2'
     >,'   w p pt 10 ps 1.5 lc 3 tit "emittance" ,\'
      write(8,fmt='(2a)')'"tunesFromFai.out" u ($13*1e2):($8) axes x1y2'
     >,'  w l lw 1.3 lc 3  notit'
      write(8,fmt='(a)') ' '
      write(8,fmt='(a)') 'pause 3 '
      write(8,fmt='(a)') ' '
      write(8,fmt='(2a)') 'set terminal postscript eps blacktext color'
