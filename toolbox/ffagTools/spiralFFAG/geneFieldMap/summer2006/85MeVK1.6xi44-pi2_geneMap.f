...
C----------------------- Data hypothesis
      TMax  = 85d6
      B0 = 15.D0        ! kG. Used for map field
      AK = 1.6D0
      XI=  44.D0  * D2R
...
C----------------------------------------
      ...
      OMEGA = TTF  /2.D0
      ttaDrft = PRIOD -TTF
      write(*,*) ' Omega = half field sector = ',omega
      write(*,*) ' Total drift sector angle in period = ',ttaDrft
C     >          ,priod*(1.-pf)
...
C----------------------------------------
      ...
      WRITE(6,*) ' Amin, Amax, R0-DR, R0 : ', amin,amax, R0-DR,R0
...
C           stop
 ...
 3    CONTINUE
     ...
     >       R0,AK,AMIN,AMAX,XACC,RO1,B1,RO2,B2,G0,C0,C1,C2,C3,C4,C5,
     >                                                  DE,FE,DS,FS)
