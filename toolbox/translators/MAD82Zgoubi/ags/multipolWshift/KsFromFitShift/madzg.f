...
C        write(89,*) ' bro, p : ',bro, pmom
C        write(89,*) ' madzg K1 : ',bk1
C        write(89,*) ' madzg K2 : ',bk2
...
C----- SEXT ***
      ...
      b3 = 10.d0 * ak2 * bro *(x10/100.d0)**2 / 2.d0
