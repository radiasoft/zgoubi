...
C      it = it + 1
 ...
 999  continue
      ...
      implicit double precision (a-h,o-z)
      parameter(G = 1.79284735, am = 938.27203d6, c=2.99792458d8)
      parameter(GgDef = 45.5)
      
c 1    continue
      write(*,*) 'Give  G*gamma  (default is ) ',GgDef
      read(*,*,err=2,end=2) Gg
      goto 3
 2    continue
      Gg = GgDef
...
C          ale = -0.5d0 * ang
      ...
      if(tilt.gt.1d-6) then
        ...
        if(kpos.eq.3 .or. kpos.eq.4) then
          ale = 0.d0
          xce=0.d0
          yce=0.d0
        endif
