...
c     >                         s,sxl,s-sxl,xl,ds,kley,name,warn
 ...
 85   continue
     ...
     >//'  ! volts, phi_s rad'
      ...
      write(lw,fmt='(A,T111,I6)') '''FIT2'''
      write(lw,fmt='(A)')   ' 2'
      write(lw,fmt='(A)')   ' 7 12 0 .2    !  HQF'
      write(lw,fmt='(A)')   ' 7 16 0 .2    !  HQD'
      write(lw,fmt='(A)')   ' 2    1E-10'
      write(lw,fmt='(A)')   ' 0.1 7 7 #End 0.08  1. 0'
      write(lw,fmt='(A)')   ' 0.1 8 8 #End 0.06  1. 0'
...
C      write(lw,fmt='(A)')   '1  11 '
      ...
      write(lw,fmt='(A)') ' '
      write(lw,fmt='(A)') '''SPNPRT'' PRINT'
      write(lw,fmt='(A)') '''SRPRNT'' '
      write(lw,fmt='(A)') ' '
...
!     > ' 1  all  PRINT    !  print-out to zgoubi.OPTICS.out' 
      ...
      write(lw,FMT='(A)')  ' 0  ! 0 for TWISS, 1 tracking'
      write(lw,FMT='(A)') ' MULTIPOL'
      write(lw,FMT='(A)') ' 0  123456'

      it = it + 1
      write(lw,FMT='(A)') 
      write(lw,fmt='(A,T111,I6)') '''SCALING''' 
      write(lw,fmt='(A)') '1  6 '
      write(lw,fmt='(A)') 'SOLENOID' 
      write(lw,fmt='(A)') '   -1   ' 
      ...
      write(lw,fmt='(2P,E16.8)') BRO
      write(lw,fmt='(A)') '1      '
      write(lw,fmt='(A)') 'MULTIPOL HQF    !  FIT #12'
      write(lw,fmt='(A)') '-1         '
      write(lw,fmt='(2P,E16.8)') BRO
      write(lw,fmt='(A)') '1      '
      write(lw,fmt='(A)') 'MULTIPOL HQD    !  FIT #16'  
      write(lw,fmt='(A)') '-1         '
      write(lw,fmt='(2P,E16.8)') BRO
      write(lw,fmt='(A)') '1      '
      write(lw,fmt='(A)') 'MULTIPOL SX1    !  FIT #20'
      write(lw,fmt='(A)') '-1         '
      write(lw,fmt='(2P,E16.8)') BRO
      write(lw,fmt='(A)') '1      '
      write(lw,fmt='(A)') 'MULTIPOL SX2    !  FIT #22'  
      write(lw,fmt='(A)') '-1         '
      write(lw,fmt='(2P,E16.8)') BRO
      write(lw,fmt='(A)') '1      '
