...
c      it = it + 1
c      write(lw,fmt='(A,T111,I6)') '''FIT''',it
c      write(lw,fmt='(A)')   ' 2'
c      write(lw,fmt='(A)')   ' 1  30 0  [-1.,1.]         !  Y_0'
c      write(lw,fmt='(A)')   ' 1  31 0  [-1.,1.]         !  T_0'
c      write(lw,fmt='(A)')   ' 2   1e-10  9999'
c      write(lw,fmt='(A)')   ' 3.1 1 2 #End .0   1. 0     ! Y_co'
c      write(lw,fmt='(A)')   ' 3.1 1 3 #End .0   1. 0     ! T_co'
C-------------------------------
      write(lw,fmt='(A)') ' '
 ...
 1    continue
     ...
     >',  G.gamma = ',1.79284735d0*gamma
      ...
      write(lw,fmt='(A)') '-3.46358498E-02 -1.46600507E-02 .0 .0 0. 1.'
...
c     > ' 2   Print out transport coeffs to zgoubi_MATRIX_out' 
      ...
      write(lw,fmt='(A)') '-1         '
      write(lw,fmt='(1P,E16.8,T20,A)') BRO*1.0009148,' ! FIT# 20'
      write(lw,fmt='(A)') '1      '
      write(lw,fmt='(A)') 'MULTIPOL QD*'
      write(lw,fmt='(A)') '-1         '
      write(lw,fmt='(1P,E16.8,T20,A)') BRO*0.99922663,' ! FIT# 24'
      write(lw,fmt='(A)') '1      '
      write(lw,fmt='(A)') 'MULTIPOL '
     >//'LSE.10602 LSE.22402 LSE.40602 LSE.52402'
      ...
      write(lw,fmt='(A)') '-1         '
      write(lw,fmt='(1P,E16.8,T20,A)') BRO*1.82800019,' ! FIT# 32'
      write(lw,fmt='(A)') '1      '
      write(lw,fmt='(A)') 'MULTIPOL LSFB*'
      write(lw,fmt='(A)') '-1         '
      write(lw,fmt='(1P,E16.8,T20,A)') BRO*0.326745391,' ! FIT# 36'
      write(lw,fmt='(A)') '1      '
      write(lw,fmt='(A)') 'MULTIPOL LSDA*'
      write(lw,fmt='(A)') '-1         '
      write(lw,fmt='(1P,E16.8,T20,A)') BRO*0.941267788,' ! FIT# 40'
      write(lw,fmt='(A)') '1      '
      write(lw,fmt='(A)') 'MULTIPOL LSDB*'
      write(lw,fmt='(A)') '-1         '
      write(lw,fmt='(1P,E16.8,T20,A)') BRO*1.00000036,' ! FIT# 44'
      write(lw,fmt='(A)') '1      '
