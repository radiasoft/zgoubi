...
C      OKECH = .FALSE.
 ...
 5    CONTINUE
        CALL SREFM(NL,LM,NT,IT,OX,Q,AM,FE,NOMFIC,OKOPN,*1)
      GOTO 21

 6    CONTINUE
        CALL SRDWM(NLOG,NL,LM,KPL,NT,IT,OX,WF,Q,AM,FE,HZ,YNRM,
     >    NOMFIC,OKECH,OKOPN,*1)
      GOTO 21
 
 7    CONTINUE
        CALL SRINM(NLOG,NL,LM,KPL,NT,IT,OX,WF,WO,Q,AM,FE,HZ,YNRM,
