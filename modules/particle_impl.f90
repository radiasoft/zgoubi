...
contains
  ...
  module procedure DBarrays2dnB
    ...
    dnB(1, 21) = D4BX(2,1,1,1)
    dnB(1, 22) = D4BX(3,1,1,1)
    dnB(1, 23) = D4BX(2,2,1,1)
    dnB(1, 24) = D4BX(3,2,1,1)
    dnB(1, 25) = D4BX(3,3,1,1)
    dnB(1, 26) = D4BX(2,2,2,1)
    dnB(1, 27) = D4BX(3,2,2,1)
    dnB(1, 28) = D4BX(3,3,2,1)
    dnB(1, 29) = D4BX(3,3,3,1)
    dnB(1, 30) = D4BX(2,2,2,2)
    dnB(1, 31) = D4BX(3,2,2,2)
    dnB(1, 32) = D4BX(3,3,2,2)
    dnB(1, 33) = D4BX(3,3,3,2)
    dnB(1, 34) = D4BX(3,3,3,3)

    dnB(2, 20) = D4BY(1,1,1,1)
    dnB(2, 21) = D4BY(2,1,1,1)
    dnB(2, 22) = D4BY(3,1,1,1)
    dnB(2, 23) = D4BY(2,2,1,1)
    dnB(2, 24) = D4BY(3,2,1,1)
    dnB(2, 25) = D4BY(3,3,1,1)
    dnB(2, 26) = D4BY(2,2,2,1)
    dnB(2, 27) = D4BY(3,2,2,1)
    dnB(2, 28) = D4BY(3,3,2,1)
    dnB(2, 29) = D4BY(3,3,3,1)
    dnB(2, 30) = D4BY(2,2,2,2)
    dnB(2, 31) = D4BY(3,2,2,2)
    dnB(2, 32) = D4BY(3,3,2,2)
    dnB(2, 33) = D4BY(3,3,3,2)
    dnB(2, 34) = D4BY(3,3,3,3)

    dnB(3, 20) = D4BZ(1,1,1,1)
    dnB(3, 21) = D4BZ(2,1,1,1)
    dnB(3, 22) = D4BZ(3,1,1,1)
    dnB(3, 23) = D4BZ(2,2,1,1)
    dnB(3, 24) = D4BZ(3,2,1,1)
    dnB(3, 25) = D4BZ(3,3,1,1)
    dnB(3, 26) = D4BZ(2,2,2,1)
    dnB(3, 27) = D4BZ(3,2,2,1)
    dnB(3, 28) = D4BZ(3,3,2,1)
    dnB(3, 29) = D4BZ(3,3,3,1)
    dnB(3, 30) = D4BZ(2,2,2,2)
    dnB(3, 31) = D4BZ(3,2,2,2)
    dnB(3, 32) = D4BZ(3,3,2,2)
    dnB(3, 33) = D4BZ(3,3,3,2)
