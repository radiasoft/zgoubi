...
chromaticities\index{Cromaticity|textbf}  and other global parameters. 
...
\noindent \textsl{KPOS} $=4 $ applies to \textsl{AGSMM} (AGS main magnet). \index{AGSMM, AGS Main Magnet} 
