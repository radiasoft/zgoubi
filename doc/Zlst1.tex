...
Various options are available and allow the control of procedures that affect certain 
...
- \textsl{SPNTRK\index{SPNTRK}}~:  switch-on spin tracking, 
 ...
 - \textsl{GETFITVAL\index{GETFITVAL}}~: collect parameter values from earlier fitting, 
...
\noindent others may  normally be declared at the end of the data pile, for instance

- \textsl{END\index{END}}~:  end of a problem, 

- \REBELOTE\index{REBELOTE}~: for tracking more than \textsl{IMAX}  particles  or for 
multi-turn tracking, 
