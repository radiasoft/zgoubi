...
\noindent The way  \textsl{KTW} works is the following: 
...
- A first pass through the structure allows computing the periodic beam matrix from the  rays, including the periodic 
dispersions. 
