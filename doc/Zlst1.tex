...
\subsection{Spectral-angular radiated densities~\protect\cite{FMSL/94-22}}\label{secSRSpec}
...
\subsubsection*{FIT:  \FITTitl}  \label{FIT} \index{FIT|textbf}
\medskip

 The keyword \textsl{FIT} allows the automatic adjustment of up to 20 
variables\index{variable (FIT)}, for fitting up to 20 constraints\index{constraint (FIT)}. It has been realized 
after existing routines used in the matrix transport code BETA~\cite{Biblio10}. %%% [10]
...
\begin{table}  %[H]
	...
	\settowidth{\LL}{\textbf{~~~~~Sigma matrix~~~~~}}
	\begin{center}
	    {\renewcommand{\arraystretch}{1}
...
\paragraph{\textit{THE FITTING METHOD \protect\cite{Biblio10}}}    %%%%[10]
...
\noindent { \it Interpolation method~: }
