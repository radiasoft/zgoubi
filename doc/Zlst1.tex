...
%
         ...
         &  &  & & & \textsl{MCOBJET}   \\
                           & & & & & & & & &  \\
%
			\multicolumn{1}{|c|}{\textbf{Inside optical}}
			    & 7.1 & $1 - \IMAX$ & $1 - 7$  & min. (1) or max. (2) value of $F(J,I)$ & 1 & 1-2 & &  
         &  \textsl{[MC]OBJET}   \\
			\multicolumn{1}{|c|}{\textbf{ elements }}
			    & 7.2 & $1 - \IMAX$ & $1 - 7$  & (min($F(J,I)$)-max($F(J,I)$))/2 &  & & & &  \\
			\multicolumn{1}{|c|}{\textbf{  }}
			    & 7.3 & $1 - \IMAX$ & $1 - 7$  & (min($F(J,I)$)+max($F(J,I)$))/2 &  & & & &  \\
			\multicolumn{1}{|c|}{\textbf{  }}
			    & 7.6 & $1 - \IMAX$ & $1 - 7$  & min. (1) or max. (2) value of $B_J$ & 1 & 1-2 & & &  \\
			\multicolumn{1}{|c|}{\textbf{  }}
			    & 7.7 & $1 - \IMAX$ & $1 - 7$  & (min($B_J$)-max($B_J$))/2 &  & & & &  \\
			\multicolumn{1}{|c|}{\textbf{  }}
			    & 7.8 & $1 - \IMAX$ & $1 - 7$  & (min($B_J$)+max($B_J$))/2 &  & & & &  \\
                            & & & & & & & & &  \\
%
...
\centerline{\includegraphics*[bbllx=20,bblly=100,bburx=567,bbury=470,width=6cm]{Fig-YZ_pwsnk.eps}}
