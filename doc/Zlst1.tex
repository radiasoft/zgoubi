...
\paragraph{\textit{OPTIONS} \index{FIT[2], options|textbf}}

\noindent \textsl{FIT} and \textsl{FIT2} accept various options, as follows. 

\smallskip

\noindent - 'nofinal'~: \index{FIT[2],~options|textbf} \label{nofinal}
...
Note that, if the `nofinal' option\index{FIT[2],~options}  
