...
\textbf{For I = 1, N}       \>A list of N records follows \>\>\\
 \\
 \LABEL's
          \> N labels at which beam centroid is to be recorded \> N string(s) \> N*A10 \\
 \\
\end{tabbing}
...
\textsl{Option}, seed \>  1 : loss entails dp only  \> $1-3$, , $>10^5$ \> I \\
                \>  2 : loss entails dp and kick angle  \> \\
...
\textbf{TWISS}         \label{TWISS-B} \index{TWISS|textbf}
  ...
  \\
  \\
 \textsl{KTW[.KTW2]},  \> $KTW=0/1/2/3$ :  Off / as \textsl{MATRIX} / and computation  of \>0-3[.1], 2*any    \>I,2*E \\
         FacD, FacA    \> chromaticities / and computation of anharmonicities.    \> \>\\
