...
\textsl{KIRD,~Resol}         
 ...
 \>  KIRD$>$0 :  numerical interpolation of field derivatives~; \>  \>\\
...
\textbf{FAISCNL}  \label{FAISCNL-B} \index{FAISCNL} 
 ...
 \textsl{FNAME}$^{ 1}$ 
       ...
       \>(e.g.,~zgoubi.fai\index{zgoubi.fai}, or b\_zgoubi.fai for binary storage). \> \> \\[60pt] 
%
%
\textbf{FAISTORE}  \label{FAISTORE-B} \index{FAISTORE} 
 ...
 \textsl{FNAME}~\footnotemark[1]$^,$\footnotemark[2] 
       \>Name of storage file (e.g.~zgoubi.fai) [~; label(s) of the element(s)  \> \>A80\\ %%
{[,}\textsl{\LABEL(s)}{]}~\footnotemark[3]  \index{LABEL@{\LABEL}}   \>  at the exit of which the store occurs (10 labels 
       maximum)]. \> \> [, 10*A10] \\
       \\
...
%
         ...
         & & & & & \textsl{[MC]OBJET}   \\
			\multicolumn{1}{|c|}{\textbf{  }}
			    & 10.1 & $1 - \IMAX$ & $1 - 3$  &$|S(J,I) - S_{initial}(J,I)|$ 
         & & & & & \textsl{+SPNTRK}   \\
			\hline
			\hline
		\end{tabular}  }
...
%
%
 \textbf{SPNSTORE}        \label{SPNSTORE-B} \index{SPNSTORE}
     \> \textbf{Store spin coordinates every $IP$ other pass} \> \> \\
\\
 \\
 \textsl{FNAME}~\footnotemark[1]
       \>Name of storage file (e.g.~zgoubi.spn) [~; label(s) of the element(s)  \> \>A80\\ %%
