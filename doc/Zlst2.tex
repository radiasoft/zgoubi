...
\\
\\
SW, I   \> 0/1/2~: off/on/on including spin kick~; beam intensity \> 0-2, Amp   \> I, E  \\
\\
$\alpha_Y, ~ \beta_Y, ~ \epsilon_Y/\pi$   \> Beam parameters, horizontal.  \>  - , m, m.rad \> 3*E  \\
\\
$\alpha_Z, ~ \beta_Z, ~ \epsilon_Z/\pi$   \> Beam parameters, vertical.  \>  - , m, m.rad \> 3*E  \\
\\
