...
\footnotetext[1]{Non-zero $\delta R\!M$ requires KIRD$>$0.} 
...
\begin{tabbing}
\mestab
 \textbf{EMMA}        \label{EMMA-B} \index{EMMA}
     \> \textbf{\EMMATitl} \> \> \\
 \\
 \\
 ...
 $IX$, $IY$, $IZ$, \textsl{MOD[.i]}      \>Number of nodes of the mesh in the $X$, $Y$    \>$\leq 400$, $\leq 200$, \>3*I \\
                              \> and $Z$ directions,  $IZ=1$ for 2-D maps~;     \>  $\ge 3$, $> 0$[.1-9] \> \\
                              \> \textsl{MOD} is a map format/lecture mode \> \> \\
                              \> \textsl{MOD}=0,~1 : Cartesian mesh, see below~; \> \> \\
                              \> \textsl{MOD}=20 : cylindrical mesh~; \> \> \\
                              \> \textsl{.i}, optional, specifies the reading \textsl{FORMAT}, default is '*'. \> \> \\
 \\
\textsl{FNAME}\footnotemark[2] \>   Names of the $NF$ files that contain the 2-D maps,   \> \>A80 \\
...
\begin{tabbing}
\mestab
 \textbf{FIT, FIT2}        \label{FIT-B} \index{FIT}\index{constraint (FIT)|textbf}\index{variable (FIT)|textbf}
          \> \textbf{\FITTitl} \> \> \\
  \\[-2ex]
...
\footnotetext[5]{$J=$ coordinate number = 1 to 7 for respectively 
$D$, $Y$, $T$, $Z$, $P$, $s$, time.}
...
\textbf{MATRIX}         \label{MATRIX-B} \index{MATRIX}
 ...
 \>     1 (normally using \textsl{OBJET}, \textsl{KOBJ} = 5): First order transfer    \> \> \\
% FM, Nov. 2008
% \>    tune numbers if \textsl{IFOC} $> 0$ \> \> \\
 \>    matrix~; if \textsl{IFOC} $> 10$: periodic beam matrix tune numbers  \> \> \\
 \>     2 (normally using \textsl{OBJET}, \textsl{KOBJ} = 6): First order transfer   \>\>\\
...
\textbf{REBELOTE} \label{REBELOTE-B} \index{REBELOTE} \index{multiparticle}\index{multiturn}
 ...
 \textsl{NPASS}\index{NPASS}, \textsl{KWRIT}, $K$ 
        \>Number of runs~; \textsl{KWRIT} = 0.0 inhibits  \>arbitrary, \>3*I\\
        \>\textsl{FORTRAN WRITE} statements onto both .res and screen~; $K$ = option \>0-1, 0 or 99 \> \\
