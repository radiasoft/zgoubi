...
%$\YC$, $\ZC$  \>(vertical) dimension $\pm \YL$ ($\pm \ZL$)~; \>\>\\
 \textsl{IFORM[.J]}, $C1$, $C2$,\>\textsl{IFORM} = 1 : rectangular collimator~;  \>1-2[.0-1] \> I, 4*E \\
                   $C3$, $C4$   \>\textsl{IFORM} = 2 : elliptical collimator. \>\>\\
                                \>\textsl{J} = 0, default : opening is $\pm \YL=\pm C1$, $\pm \ZL=\pm C2$,  \>\>\\
                                \> centered at $\YC=C3$, $\ZC=C4$. \>\>\\
                                \>\textsl{J} = 1 : opening is,  Y~: $[C1,C2]$, Z~: $[C3,C4]$ \>\>\\
\\
...
\textbf{MATRIX}         \label{MATRIX-B} \index{MATRIX|textbf}
 ...
 \textsl{[, zgoubi.MATRIX.out]} \> \textsl{IORD} = 0 : Same effect as \textsl{FAISCEAU} \>$>10$ \> \\
...
\textbf{REBELOTE} \label{REBELOTE-B} \index{REBELOTE} \index{multiparticle}\index{multiturn}
 ...
 \textsl{NPASS}\index{NPASS}, \textsl{KWRIT}, $K$\textsl{[.n]}, 
                                       \>Number of runs~; \textsl{KWRIT} = 1.1 (resp. 0.0) switches   \>arbitrary, \>3*I\\
 \textsl{[, Label1 [, Label2]]}        \>(resp. inhibits) \textsl{FORTRAN WRITE}s to both .res and screen~; \> \\
        \> $K$ = option \>0-1, 0 or 99 \> \\
 ...
 \>pass are used as initial coordinates for the \>\>\\
 \>next one~; idem for spin components.   \>\>\\
 \>$K=99.1$ : Label1 is expected, subsequent passes will start from Label1~; \>\>\\
 \>$K=99.2$ : Label1 and Label2 are expected, last pass (\# IPASS+1) will end at Label2. 
\end{tabbing}
