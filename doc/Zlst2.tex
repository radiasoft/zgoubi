...
\mestab
 ...
 \\
\textsl{KSR[.i]}     \> On/off switch~; $i=1$ for info output  into \texttt{zgoubi.SRLOSS.out}       \> $0-1[.0-.1]$  \> 2*I \\
\\
\textsl{STR1, STR2} \> Options~: \textsl{STR1 = 'ALL'} or \textsl{'all'} or a particular  KEYWORD~;  \> 2*A \\
 ...
 \\
\textsl{Option}, seed \>  Option~: 0 / no effect, 1 / SR causes dp only,   \> $1-3$,  $>10^5$ \> I \\
