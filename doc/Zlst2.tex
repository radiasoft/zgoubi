...
\\
 ...
 \\
\textbf{If KOBJ=3[.NN,}\\
\hskip1em\textbf{NN=00,01]}      \>Reads coordinates from a storage file \> \> \\
                     \> NN=00 : zgoubi.fai like data file FORMAT  \> \> \\
                     \> NN=01 : read FORMAT is \texttt{\small``READ(NL,*,ERR=97,END=95) Y,T,Z,P,S,DP''}   \> \> \\
 \\
