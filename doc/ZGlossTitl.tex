...
%%
\newcommand{\AIMANTTitl}{Generation of a dipole magnet mid-plane 2-D map}
\newcommand{\AUTOREFTitl}{Automatic transformation to a new reference frame}
\newcommand{\BENDTitl}{Bending magnet}
...
\newcommand{\DIPOLETitl}{Dipole magnet}
\newcommand{\DIPOLESTitl}{Dipole magnet $N$-uplet}
\newcommand{\DIPOLEMTitl}{Generation of a dipole magnet mid-plane 2-D map}
...
\newcommand{\FFAGTitl}{FFAG magnet, $N$-uplet}
\newcommand{\FFAGSPITitl}{Spiral FFAG magnet, $N$-uplet}
...
\newcommand{\MATPRODTitl}{Matrix transfer}
...
\newcommand{\REBELOTETitl}{Jump to the beginning of \zgoubi input data file}
...
\newcommand{\SPNPRNLATitl}{Store spin coordinates every $IP$ other pass}
...
\newcommand{\VENUSTitl}{Simulation of a rectangular dipole magnet}
