...
\bf IZ & ~ ~ & \bf         MOD   &\bf      .MOD2 &   & \\[1ex]
 1   & & 0 &     none                     &  \multirow{2}{90mm}{{\bf \large 2-D} map, a single  data file for  $B_Z(X,Y)|_{Z=0}$, mid-plane symmetry.} \\[4ex]
...
1 &&        1     &  none                 &  \multirow{1}{90mm}{{\bf \large 2-D} map, one mid-plane $B_Y(X,Y)$ data field map.} \\[3ex]
$>1$ &&        1     &  none              &  \multirow{2}{90mm}{{\bf \large 3-D} map, IZ files containing $B_{X,Y,Z}(X,Y,Z)$ data, one per (X,Y) plane, no symmetry assumed.} \\[4ex]
...
$>1$ &&   15    &      .1 $-$ .4          &  \multirow{4}{90mm}{{\bf \large 3-D} field map. Up to 4 files, whole magnet volume each (no symmetry assumed). Fields summed up~: at all node, $\vec B = \sum_{i=1}^{i=MOD2} a_i \, \vec B_i $. Each map file contains $B_{X,Y,Z}(X,Y,Z)$ data over  \IZ\ equally $Z$-spaced $(X,Y)$ planes}  \\[14ex]
%
 \multicolumn{4}{l}{\underline{\bf MOD $\geq$ 20   : Cylindrical mesh}}   \\[1.5ex]
\bf IZ & ~ ~ & \bf         MOD   &\bf      .MOD2 &   & \\[1ex]
&&       20, 21  &                        &  \multirow{2}{90mm}{{\bf \large 3-D} map, single file, half a magnet, cylindrical symmetry with respect to (Y,Z) plane.} \\[4ex]
  1    &&       22  &    .1 $-$ .4  &  \multirow{1}{90mm}{{\bf \large 2-D} field map, 1 to 4 files to be superimposed. } \\[2ex]
 $>1$  &&       22  &    .1 $-$ .4        &  \multirow{4}{90mm}{{\bf \large 3-D} field map. Up to 4 files, whole magnet volume each (no symmetry assumed). Fields summed up~: at all node, $\vec B = \sum_{i=1}^{i=MOD2} a_i \, \vec B_i $. Each map file contains $B_{X,Y,Z}(X,Y,Z)$ data over  \IZ\ equally $Z$-spaced $(X,Y)$ planes}  \\[14ex]
\end{tabular}
\end{table}
