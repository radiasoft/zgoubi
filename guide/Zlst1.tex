...
\noindent Cavity simulations are done in cavite.f. Management of the reference rigidity 
...
\noindent Solenoid parameters are read from zgoubi.dat by rsolen.f. Initializations prior to tracking done in soleno.f. 
Field computation during tracking is in solenf.f. 
...
$\diamond$ including  `RHIC\_helix' will normalize \textsl{BNORM} to measured B field value  
  versus helix current (measured B(I) data are hard-coded in program toscac.f). In that case, 
