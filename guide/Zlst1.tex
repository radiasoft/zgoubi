...
This defines for each plane an elliptical  frontier $\dfrac{1 + \alpha^2_Y}{\beta_Y} Y^2 + 2 \alpha_Y YT + \beta_Y T^2 = 
\varepsilon_Y / \pi$ (\id\ for the ($Z, P$) or ($X, D$) planes). 
$N_{\varepsilon_ Y}$, $N_{\varepsilon_ Z}$ and 
