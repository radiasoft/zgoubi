...
As to solving the differential eq.~\ref{eqRadPolar}, the methods follows the \zgou\ method, namely, 
...
detailed in Sec.~\ref{sec2.2}. The derivatives of the polarization vector are computed as detailed in ec.~\ref{SecSpinIntro}. 
 ...
 \subsection{Spin Diffusion} \label{secRadiatPolar}
...
\paragraph{\textsl{FIT[2] OPTIONS} \index{fit procedure!- options|textbf}}
...
\subsubsection{GETFITVAL~: \GETFITVALTitl} \label{GETFITVAL}\index{GETFITVAL|textbf} \index{FIT[2]}
\medskip
