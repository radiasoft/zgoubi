...
\subsubsection*{INCLUDE~: \INCLUDETitl~\cite{Pavel}} \label{INCLUDE} \index{INCLUDE|textbf}
\medskip

******** To be completed ************

\noindent \textsl{INCLUDE} works much like the fortran ``include'' statement~: 
 it directs the \zgoubi\ to stop reading the optical sequence from the current file and read 
instead in an included file. 
