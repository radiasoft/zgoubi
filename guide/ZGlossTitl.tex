...
\newcommand{\AUTOREFTitl}{Transport beam into a new reference frame}
\newcommand{\BEAMBEAMTitl}{Beam-beam lens}
\newcommand{\BENDTitl}{Bending magnet, Cartesian frame}
\newcommand{\BETATRONTitl}{Betatron core (momentum kick)}
...
\newcommand{\ERRORSTitl}{Injecting errors in optical elements}
...
\newcommand{\GOTOTitl}{Branching statement}
...
\newcommand{\INCLUDETitl}{File include statement}
...
\newcommand{\OPTICSTitl}{Write out  optical functions. Log to zgoubi.OPTICS.out}
\newcommand{\OPTIONSTitl}{Global or special options}
\newcommand{\ORDRETitl}{Taylor expansions order}
\newcommand{\PARTICULTitl}{Particle characteristics}
\newcommand{\PICKUPSTitl}{Bunch centroid path; orbit}
...
\newcommand{\SPACECHARGTitl}{Space charge}
...
\newcommand{\TWISSTitl}{Calculation of periodic optical parameters. Log to zgoubi.TWISS.out}
