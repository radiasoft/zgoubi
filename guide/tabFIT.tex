...
%	 & 0& 1 - 6 & 1 - 6 & $\sigma_{I\! J}$~~  ($\sigma_{11}=\beta_Y$, $\sigma_{12}=\sigma_{21}=\alpha_Y$, etc.) 
	 ...
	 \multicolumn{1}{|c|}{\textbf{Periodic \mbox{$\sigma$-matrix} }} 
	         ...
	         & & &  \scriptsize  \textsl{OBJET/KOBJ=5 if} \\
	 \multicolumn{1}{|c|}{ ($\sigma \! = \! I \cos \!  \mu + J \sin\!  \mu$), }  & ($N\le 9$) &  7 & any & $\mu_Y/2\pi$ & & &  \scriptsize  \textsl{ $N=1$, } \\
			\multicolumn{1}{|c|}{\textbf{tunes} $(N=1-9$ \textsl{ for}  }& & 8 & any & $\mu_Z/2\pi$ & & &
                        \scriptsize  \textsl{OBJET/KOBJ=5.N if } \\
			\multicolumn{1}{|c|}{ {\footnotesize \textsl{ MATRIX block 1-9) }}} & &  9 & any & $\cos(\mu_Y)$  & & &  \textsl{ $N\geq 2$}\\
	...
	\multicolumn{1}{|c|}{\textbf{transport coeffs. \&}} &   & 7 & j & $j\ne 8$~: YY-determinant~; j=8~: YZ-det.  & & &   \\
		\multicolumn{1}{|c|}{\textbf{determinants. }}          &   & 8 & j & $j\ne 7$~: ZZ-determinant~; j=7~: ZY-det.   & & &   \\
	\multicolumn{1}{|c|}{\textbf{Chromas.}} & 1.1  & 7 & 7 & $dQ_Y\, /\, dp/p$ & & &   \scriptsize  \textsl{OBJET/KOBJ=5.2}   \\
		\multicolumn{1}{|c|}{\textbf{ }} &   & 8 & 8 & $dQ_Z\, /\, dp/p$   & & &   \\
                           & & & & & & &   \\
...
%
         ...
         \multicolumn{8}{l}{\textsl{F(J,I)} : particle coordinate array~; J~: coordinate (1-7 for respectively D, Y, T, Z, P, S, time, resp. units~: none, cm, mrad, cm, mrad, cm, $\mu$s)~; I~: particle number.}   \\[.2ex]
         \multicolumn{8}{l}{\textsl{FO(J,I)} : initial particle coordinates.}   \\[.2ex]
         \multicolumn{8}{l}{\textsl{S(J,I)} : spin coordinate array~; J~: coordinate (1, 2, 3 for respectively X, Y, Z)~; I~: particle number.}   \\[.2ex]
         \multicolumn{8}{l}{\textsl{SO(J,I)} : initial spin coordinates.}   \\[.2ex]
			\hline
		\end{tabular}  }
~ ~ ~ \\
~ ~ ~ \\
