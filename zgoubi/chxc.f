...
C     --------------------------------------------------
      ...
      INCLUDE 'C.QUA.H'     ! COMMON/QUA/ BO,RO,FG,GF,XI,XF,EN,EB1,EB2,EG1,EG2
...
C---------- Magnetic
     ...
     >DEV,RTB,XL,BM,DLE,DLS,DI,DS,XE,XS, CE ,CS ,BORO,DPREF,HDPRF,*95)
               DSREF = XL
...
C------- AGSMM. AGS main magnet
     ...
     >  DEV,RTB,XL,BM,DLE,DLS,DI,DS,XE,XS,CE,CS,BORO,DPREF,HDPRF)
