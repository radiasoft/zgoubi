...
C          WRITE(LUN,54)'@ Q2               %le', ZNUREF,'   [+ integer]'
     ...
     >    (sqrt((BORO*CL9*Q*(DPREF+HDPRF)*REF(6))**2+AMASS*AMASS)-AMASS)
     >    /1.d3,']'
