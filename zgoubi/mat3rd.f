...
C     ------------------------------------------------------
      ...
      DIMENSION XO(MXT), YO(MXT), ZO(MXT), VXO(MXT), VYO(MXT)
     1, VZO(MXT), RTL(MXT),RLL(MXT)
      DIMENSION XI(MXT), YI(MXT), ZI(MXT), VXI(MXT), VYI(MXT)
     1, VZI(MXT),DELP(MXT)
...
C****
C***
      call MAT3ca(XO,YO,ZO,VXO,VYO,VZO,RTL,RLL,PL_D,XM,TM,YM,PM,DM,j)
...
C**
      NRC=82
       CALL MAT3TR(L,IMAX,X,XO,YO,ZO,VXO,VYO,VZO,PL_D,RLL)
C*
