...
C  France
      SUBROUTINE MULTIP(ID,KFL,KUASEX,X,Y0,Z0,BM,DLEM,DLSM,DFM,DE,DS,RT
     >,XE,XS,CE,CS
     >,B,DB,DDB,D3BX,D3BY,D3BZ,D4BX,D4BY,D4BZ,BT)
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      PARAMETER(MPOL=10)
      DIMENSION BM(MPOL),DLEM(MPOL),DLSM(MPOL),DFM(MPOL)
...
C-----  END DIP
      ...
      CALL ADPOL(ID,IOP,KFL,B,DB,DDB,D3BX,D3BY,D3BZ,D4BX,D4BY,D4BZ,BT)
...
C-----  END 20-POLE
 ...
 91   CONTINUE
      I3 = 3
      CALL ADPOL(ID,I3,KFL,B,DB,DDB,D3BX,D3BY,D3BZ,D4BX,D4BY,D4BZ,BT)
