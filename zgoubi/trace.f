...
C     $     IREP(MXT),AMQLU,PABSLU
      ...
      IF(NRES .GT. 0) WRITE(NRES,100) MY,MZ,XI,YIO,YMI
    ...
    1 CONTINUE
      ...
      IF(NRES .GT. 0) WRITE(NRES,101) MY,XI,YIO,YMI
  ...
  100 FORMAT('1',3X,' ABERRATIONS VERTICALES',/
     ...
     2,3X,' CENTRE DE GRAVITE DECALE DE',E9.2,' CM')
  101 FORMAT('1',3X,' TRAJECTOIRES DU PLAN MEDIAN',/
     1,3X,' MAILLE EN Y=' ,I4
     1,' MM   EN X=10CM    POINT CENTRAL  X=',1P,E9.2,' CM  Y=',E9.2
     1,' CM',/,3X,' CENTRE DE GRAVITE DECALE DE',E9.2,' CM')
      END
