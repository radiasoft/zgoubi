...
Track a proton on its periodic circular orbit across this 60-degree sector, 
assuming the orbit centered at the center of the field map, 
for a few different values of proton momentum ranging from 1~MeV to 5~MeV.
 Plot, as a function of momentum, the 
equilibrium orbit radius $R$ and  time of flight $T_{\rm rev}$ on that orbit, 
 from both ray-tracing and relativistic kinematics on a same graphic,  
showing   the slow TOF increase with momentum. 

\noindent ~\ref{secCycloClassTra}-1.c - 
...
\subsection{Resonant acceleration \label{secCycloClassAccel}}
...
{
1/ On RF harmonic 1, which RF frequency applied on dees 
is needed to accelerate a proton in a $\sim$uniform, 1~Tesla magnetic field~? 

~

2/ What is the  energy gained by a proton when it reaches $r=0.3\,$m~?
}
