...
it was  that of a  magnetic field region between to magnetic poles 
including a double-Dee system that creates a pair of accelerating gaps (Fig.~\ref{figLBLCycloSketch}).  
In that sense it was understood by its inventor as a  ``folded linac'' structure~\cite{TBRef'd},  
allowing  repetitive  passes through a single accelerating device, a circular accelerator in other words. 
...
using two different methods, namely, 1-turn mapping and  Fourier analysis of multi-turn motion. 
