...
\begin{center}
\includegraphics*[width=0.64\linewidth]{./figs_cyclo_introSlides/AGSString.eps}
\end{center}
...
\includegraphics[width=6cm]{./figs_cyclo_introSlides/frameB.eps}
...
and thus get the first integrals
   \hfill \raisebox{-30mm}[0mm][0mm]{\includegraphics[width=6cm]{./figs_cyclo_introSlides/frameB.eps}}
...
Introducing the initial conditions, at $t=0$~:  $s_0=0$, $x_0=0$, $\dot s = \dot s_0$, $\dot x = \dot x_0$
   \hfill \raisebox{-40mm}[0mm][0mm]{\includegraphics[width=6cm]{./figs_cyclo_introSlides/frameB.eps}}
...
\hfill DISCUSSION   \hfill ~ ~ 
   ...
   \hfill \raisebox{-10mm}[0mm][0mm]{\rotatebox{-70}{\includegraphics[width=6cm]{./figs_cyclo_introSlides/3doigts.eps}}}  \hfill ~


~

\hfill \includegraphics[width=9cm]{./figs_cyclo_introSlides/framebBpos.eps}  \hfill \includegraphics[width=9cm]{./figs_cyclo_introSlides/frameqBneg.eps} \hfill ~
